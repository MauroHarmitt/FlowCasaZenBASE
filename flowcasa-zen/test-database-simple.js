/**
 * 🗄️ PRUEBA SIMPLE DE INTEGRIDAD DE BASE DE DATOS
 * 
 * Este script verifica que la base de datos esté funcionando correctamente
 * para usuarios y clases, sin requerir mongoose
 */
...
async function main() {
    ...
    // Prueba 2: Probar que no se pueda acceder sin servidor
    console.log('2️⃣ Probando que NO se pueda acceder sin servidor...');
    if (await testNoServerAccess()) {
        testsPassed++;
    }
    console.log('');
    ...
    if (testsPassed === totalTests) {
        ...
        console.log('✅ NO se puede acceder sin servidor');
    } else {
